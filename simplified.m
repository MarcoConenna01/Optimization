...
hold on
contour(eps,Ln,g1,[0 0],'r',LineWidth=1); %thickness max
hold on
contour(eps,Ln,g1,[0.05 0.05],'--r',LineWidth=1);
hold on
contour(eps,Ln,g2,[0 0],'r',LineWidth=1); %thickness min
hold on
contour(eps,Ln,g2,[0.05 0.05],'--r',LineWidth=1);
hold on
contour(eps,Ln,g3,[0 0],'b',LineWidth=1); %alpha min
hold on
contour(eps,Ln,g3,[0.05 0.05],'--b',LineWidth=1);
hold on
contour(eps,Ln,g4,[0 0],'b',LineWidth=1); %alpha max
hold on
contour(eps,Ln,g4,[0.05 0.05],'--b',LineWidth=1);
hold on
...
hold on
contour(eps,Ln,g6,[0.05 0.05],'--g',LineWidth=1);
hold on
